...
namespace rfb {
  ...
  /* QuantaVNC PQC VeNCrypt subtypes */
  const int secTypePQKEMNone      = 276;
  const int secTypePQKEMVnc       = 277;
  const int secTypePQKEMPlain     = 278;

  /* QuantaVNC PQC-TLS VeNCrypt subtypes */
  const int secTypePQTLSNone      = 280;
  const int secTypePQTLSVnc       = 281;
  const int secTypePQTLSPlain     = 282;
  const int secTypePQX509None     = 283;
  const int secTypePQX509Vnc      = 284;
  const int secTypePQX509Plain    = 285;
