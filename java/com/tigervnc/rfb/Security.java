...
public class Security {
  ...
  // QuantaVNC PQC types
  public static final int secTypePQKEMNone   = 276;
  public static final int secTypePQKEMVnc    = 277;
  public static final int secTypePQKEMPlain  = 278;
  public static final int secTypePQTLSNone   = 280;
  public static final int secTypePQTLSVnc    = 281;
  public static final int secTypePQTLSPlain  = 282;
  public static final int secTypePQX509None  = 283;
  public static final int secTypePQX509Vnc   = 284;
  public static final int secTypePQX509Plain = 285;
  ...
  public static int secTypeNum(String name) {
    ...
    // QuantaVNC PQC types
    if (name.equalsIgnoreCase("PQKEMNone"))   return secTypePQKEMNone;
    if (name.equalsIgnoreCase("PQKEMVnc"))    return secTypePQKEMVnc;
    if (name.equalsIgnoreCase("PQKEMPlain"))   return secTypePQKEMPlain;
    if (name.equalsIgnoreCase("PQTLSNone"))   return secTypePQTLSNone;
    if (name.equalsIgnoreCase("PQTLSVnc"))    return secTypePQTLSVnc;
    if (name.equalsIgnoreCase("PQTLSPlain"))   return secTypePQTLSPlain;
    if (name.equalsIgnoreCase("PQX509None"))  return secTypePQX509None;
    if (name.equalsIgnoreCase("PQX509Vnc"))   return secTypePQX509Vnc;
    if (name.equalsIgnoreCase("PQX509Plain")) return secTypePQX509Plain;
  ...
  public static String secTypeName(int num) {
    ...
    // QuantaVNC PQC types
    case secTypePQKEMNone:   return "PQKEMNone";
    case secTypePQKEMVnc:    return "PQKEMVnc";
    case secTypePQKEMPlain:  return "PQKEMPlain";
    case secTypePQTLSNone:   return "PQTLSNone";
    case secTypePQTLSVnc:    return "PQTLSVnc";
    case secTypePQTLSPlain:  return "PQTLSPlain";
    case secTypePQX509None:  return "PQX509None";
    case secTypePQX509Vnc:   return "PQX509Vnc";
    case secTypePQX509Plain: return "PQX509Plain";
