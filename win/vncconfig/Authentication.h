...
namespace rfb {
  ...
  namespace win32 {
    ...
    public:
      ...
      // TODO: PQC options would be added here when HAVE_LIBOQS is available
      // The checkbox for "Require post-quantum key exchange" would be
      // integrated into the security page alongside existing auth options.
